...
pygame.display.set_caption("RockPaperScissorsMultiplayer")
class Button:
...
def redrawWindow(win, game, p):
    win.fill((90, 90, 90)) # fill window with a background colour
    # player.draw(window)
    # player2.draw(window)
...
btns = [Button("Rock", 25, 250, (0, 0, 0)), Button(
    "Scissors", 125, 250, (255, 0, 0)), Button("paper", 225, 250, (0, 255, 0))]
